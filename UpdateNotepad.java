...
public class UpdateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://106.12.148.140/Linux_Exam";
    final static String USER = "root";
    final static String PASS = "23392339YKMykm$";
    final static String SQL_INSERT_NOTEPAD = "UPDATE  notepad SET notepadContent=? WHERE id=?";
